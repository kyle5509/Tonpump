...
export default function Market() {
  ...
  return (
    <motion.div
      ...
      className={`flex xl:hidden h-full flex-col overflow-y-auto w-full `}
    >
      ...
      <div className="p-2 bg-[#272727] flex-1 mt-2 ">
        ...
        <Input
          ...
          value=""
        />
        <Input label="Qty" value="" text="TON" marginTop="10px" placeholder="58403" />
        <Input label="Total" value="" text="USD" marginTop="30px" placeholder="" />
