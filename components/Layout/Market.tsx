...
import Input2 from "../General/Input2";
export default function Market() {
  ...
  return (
    <div className="lg:p-2 h-full w-full">
      <div
        className={`flex lg:border-2 xl:w-[310px] h-full 2xl:w-[335px] lg:rounded-2xl border-purplee flex-col w-full `}
      >
        <div className="ml-3 xl:ml-2 mt-2 mb-4">
          <Title parentStyle="h-[45px]" title="Trade" />
        </div>
        <div className="p-3 xl:p-2 rounded-2xl bg-[#272727] flex-1 mt-2 ">
          ...
          <div className="space-y-3 mt-3">
            <Input2
              ...
              placeholder="58403"
            />
            <Input2 label="Qty" subLabel="TON"
              placeholder="58403" />
            <Input2 label="Total" subLabel="USD"
              placeholder="" />
          </div>
